namespace Micron.Tests
{
    ...
    public class IntegrationTests
    {
        ...
        public async Task Can_pull_it_all_together()
        {
            ...
            var configurer = new DbCommandConfigurerPipeline(cmd =>
            {
                cmd.CommandTimeout = 5;
                return cmd;
            });

            var handlerFactory = new DbCommandHandlerFactory(retry, logger, configurer);
            var handler = handlerFactory.Build();
